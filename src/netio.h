#ifndef SILLYBEAR_NETIO_H
#define SILLYBEAR_NETIO_H
...
enum sillybear_prio {
	SILLYBEAR_PRIO_NORMAL = 0, /* the rest - tcp-fwd, scp, rsync, git, etc */
	SILLYBEAR_PRIO_LOWDELAY, /* pty shell, x11 */
};
...
/* result is SILLYBEAR_SUCCESS or SILLYBEAR_FAILURE.
errstring is only set on SILLYBEAR_FAILURE, returns failure message for the last attempted socket */
